...
export type McpCatalogEntry = { configScope: (McpConfigScope) | (null); configWritable: boolean; enabled: boolean; hasCredentials: boolean; oauthCapable: boolean; runtimeConnected: boolean; status: McpStatus; };
...
export interface ApiOperations {
  ...
  "v2.agents.list": { method: "GET"; path: "/v2/agents"; input: { query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": AgentList; }; response: AgentList; };
  ...
  "v2.capabilities.list": { method: "GET"; path: "/v2/capabilities"; input: { query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": Array<Capability>; }; response: Array<Capability>; };
  ...
  "v2.management.skills.versions.get": { method: "GET"; path: "/v2/management/skills/{id}/versions/{version}"; input: { path: { id: string; version: string; }; query?: { scope?: "installation" | "workspace"; directory?: string; }; headers?: { "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": SkillVersion; }; response: SkillVersion; };
  "v2.management.skills.versions.list": { method: "GET"; path: "/v2/management/skills/{id}/versions"; input: { path: { id: string; }; query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": Array<SkillVersion>; }; response: Array<SkillVersion>; };
  "v2.management.skills.versions.restore": { method: "POST"; path: "/v2/management/skills/{id}/versions/{version}/restore"; input: { path: { id: string; version: string; }; query?: { directory?: string; expectedRevision?: string; scope?: "installation" | "workspace"; }; headers?: { "If-Match"?: string; "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": ManagedResource; }; response: ManagedResource; };
  ...
  "v2.plugins.workflows.activate": { method: "POST"; path: "/v2/plugins/dev.neoism.workflows/{workflow_id}/activate"; input: { path: { workflow_id: string; }; query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": WorkflowProjection; }; response: WorkflowProjection; };
  "v2.plugins.workflows.create": { method: "POST"; path: "/v2/plugins/dev.neoism.workflows"; input: { query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "X-Neoism-Directory"?: string; }; body: WorkflowDefinition; signal?: AbortSignal; }; responses: { "201": WorkflowView; }; response: WorkflowView; };
  "v2.plugins.workflows.delete": { method: "DELETE"; path: "/v2/plugins/dev.neoism.workflows/{workflow_id}"; input: { path: { workflow_id: string; }; query?: { directory?: string; expectedRevision?: string; scope?: "installation" | "workspace"; }; headers?: { "If-Match"?: string; "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "204": void; }; response: void; };
  "v2.plugins.workflows.get": { method: "GET"; path: "/v2/plugins/dev.neoism.workflows/{workflow_id}"; input: { path: { workflow_id: string; }; query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": WorkflowView; }; response: WorkflowView; };
  "v2.plugins.workflows.history": { method: "GET"; path: "/v2/plugins/dev.neoism.workflows/{workflow_id}/runs"; input: { path: { workflow_id: string; }; query?: { directory?: string; limit?: number; scope?: "installation" | "workspace"; }; headers?: { "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": WorkflowHistory; }; response: WorkflowHistory; };
  "v2.plugins.workflows.list": { method: "GET"; path: "/v2/plugins/dev.neoism.workflows"; input: { query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": WorkflowCatalog; }; response: WorkflowCatalog; };
  "v2.plugins.workflows.patch": { method: "PATCH"; path: "/v2/plugins/dev.neoism.workflows/{workflow_id}"; input: { path: { workflow_id: string; }; query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "If-Match"?: string; "X-Neoism-Directory"?: string; }; body: WorkflowDefinitionPatch; signal?: AbortSignal; }; responses: { "200": WorkflowView; }; response: WorkflowView; };
  "v2.plugins.workflows.pause": { method: "POST"; path: "/v2/plugins/dev.neoism.workflows/{workflow_id}/pause"; input: { path: { workflow_id: string; }; query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": WorkflowProjection; }; response: WorkflowProjection; };
  "v2.plugins.workflows.preview": { method: "GET"; path: "/v2/plugins/dev.neoism.workflows/{workflow_id}/preview"; input: { path: { workflow_id: string; }; query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": WorkflowPreview; }; response: WorkflowPreview; };
  "v2.plugins.workflows.run": { method: "POST"; path: "/v2/plugins/dev.neoism.workflows/{workflow_id}/run"; input: { path: { workflow_id: string; }; query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": WorkflowRun; }; response: WorkflowRun; };
  "v2.plugins.workflows.runs.get": { method: "GET"; path: "/v2/plugins/dev.neoism.workflows/{workflow_id}/runs/{run_id}"; input: { path: { workflow_id: string; run_id: string; }; query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": WorkflowRun; }; response: WorkflowRun; };
  "v2.plugins.workflows.runs.retry": { method: "POST"; path: "/v2/plugins/dev.neoism.workflows/{workflow_id}/runs/{run_id}/retry"; input: { path: { workflow_id: string; run_id: string; }; query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": WorkflowRun; }; response: WorkflowRun; };
  "v2.plugins.workflows.update": { method: "PUT"; path: "/v2/plugins/dev.neoism.workflows/{workflow_id}"; input: { path: { workflow_id: string; }; query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "If-Match"?: string; "X-Neoism-Directory"?: string; }; body: WorkflowDefinition; signal?: AbortSignal; }; responses: { "200": WorkflowView; }; response: WorkflowView; };
  ...
  "v2.providers.configured": { method: "GET"; path: "/v2/providers/configured"; input: { query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": ConfigProvidersResult; }; response: ConfigProvidersResult; };
  ...
  "v2.skills.list": { method: "GET"; path: "/v2/skills"; input: { query?: { directory?: string; scope?: "installation" | "workspace"; }; headers?: { "X-Neoism-Directory"?: string; }; signal?: AbortSignal; }; responses: { "200": SkillList; }; response: SkillList; };
