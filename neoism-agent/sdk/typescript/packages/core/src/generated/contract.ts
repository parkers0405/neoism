...
export type EventMessagePartUpdated = { data: { part: { author?: string; id: string; role?: string; system?: string; type: string; [key: string]: unknown; }; sessionID: string; time: number; }; id: string; schemaVersion: string; sequence: number; source: string; subject?: EventSubject; timestamp: number; type: "message.part.updated"; };
...
export type Part = { id: string; messageId: string; sessionId: string; type: string; [key: string]: unknown; };
