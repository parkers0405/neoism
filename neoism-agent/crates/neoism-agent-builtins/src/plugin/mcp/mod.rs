...
impl PluginDefinition for McpPlugin {
    fn manifest(&self) -> PluginManifest {
        PluginManifest {
            ...
            internal: true,
            disableable: true,
            capabilities: vec!["neoism.mcp".into()],
            requires: vec![super::config::ID.into()],
            event_namespaces: vec!["mcp".into()],
    ...
    fn required_capabilities(&self) -> Vec<neoism_agent_plugin_api::HostCapability> {
        ...
        vec![ConfigRead, Network, ProcessSpawn, SecretRead]
    }
    fn contributions(
        &self,
