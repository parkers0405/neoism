//! Windows ACL hardening for secret files (provider credentials in
//! `auth.json`, MCP OAuth tokens). Duplicated from
//! `neoism-workspace-daemon/src/windows_acl.rs` — this repo prefers small
//! duplicated helpers over new shared crates.
//!
