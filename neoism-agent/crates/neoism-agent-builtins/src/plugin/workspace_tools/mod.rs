...
impl PluginDefinition for WorkspaceToolsPlugin {
    ...
    fn required_capabilities(&self) -> Vec<neoism_agent_plugin_api::HostCapability> { use neoism_agent_plugin_api::HostCapability::*; vec![WorkspaceRead, WorkspaceWrite, ProcessSpawn, EventPublish, Network] }
