...
pub(crate) const EX_COMMANDS: &[(&str, &str)] = &[
    ...
    ("q", "quit current"),
    ("quit", "quit"),
    ("q!", "discard+quit current"),
    ("quit!", "discard+quit current"),
    ("close", "close current"),
    ("close!", "discard+close current"),
    ("qa", "quit workspace"),
    ("qa!", "discard+quit workspace"),
    ("qall", "quit workspace"),
    ("qall!", "discard+quit workspace"),
    ("quitall", "quit workspace"),
    ("quitall!", "discard+quit workspace"),
    ("split", "horiz split"),
    ("vsplit", "vert split"),
    ("tabnew", "new tab"),
