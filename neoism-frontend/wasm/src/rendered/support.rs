...
pub(crate) fn palette_action_name(
    ...
    match action {
        ...
        A::CreateDocumentationNotebook => "CreateDocumentationNotebook",
        A::OpenDocumentationNotebook => "OpenDocumentationNotebook",
        A::LinkMarkdownFile => "LinkMarkdownFile",
