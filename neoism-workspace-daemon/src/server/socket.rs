    ...
    loop {
        ...
        let frame = tokio::select! {
            out = output_rx.recv() => {
                match out {
                    Ok(out) => {
                        // PTY cwd is per-session metadata. Never broadcast a
            ...
            match msg {
                ...
                ServiceClientMessage::Files {
                    ...
                    let required = match &message {
                        ...
                        | FilesClientMessage::BrowserListDir { .. }
                        | FilesClientMessage::BrowserStat { .. }
                        | FilesClientMessage::BrowserReadFile { .. }
        ...
        spans
            ...
            .map(|(token, start, end)| SyntaxSpan {
                token: match token {
                    ...
                    SynTok::Property => SyntaxToken::Property,
                    SynTok::Constructor => SyntaxToken::Constructor,
                    SynTok::Special => SyntaxToken::Special,
